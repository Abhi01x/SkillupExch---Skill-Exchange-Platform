  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="relative overflow-hidden">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="animate-fade-in-up">
              <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 text-primary-200 text-sm font-medium mb-6">
                ...
                Free Peer-to-Peer Learning Platform
              </span>
            </div>
            ...
            <h1 className="animate-fade-in-up text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white mb-6 tracking-tight leading-tight">
              Exchange Skills,<br />
              <span className="text-white">Empower Futures</span>
            </h1>

            <p className="animate-fade-in-up-delay text-lg sm:text-xl text-primary-200 max-w-2xl mx-auto mb-10 leading-relaxed">
              Learn coding, design, languages, and more from fellow students.
              Share what you know, learn what you don't. Zero cost, infinite possibilities.
            </p>
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <svg viewBox="0 0 1440 80" fill="none" className="w-full">
            <path
              d="M0 80V40C240 70 480 10 720 40C960 70 1200 10 1440 40V80H0Z"
              fill="#f8fafc"
            />
          </svg>
        </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {[
              ...
              >
                ...
                <span className="absolute top-6 right-6 text-5xl font-black text-slate-100 group-hover:text-primary-100 transition-colors">
                  {feature.step}
                </span>

                <div className={`w-14 h-14 ${feature.color === 'accent'
      ...
      <section className="py-20 sm:py-28 px-4 text-center">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-lg text-slate-500 mb-8">
            Join thousands of students already exchanging skills on our platform.
          </p>
      ...
      <footer className="border-t border-slate-200 py-8 text-center text-sm text-slate-400">
        ...
        <p>
          &copy; {new Date().getFullYear()} SkillExchange. Built for students, by students.
        </p>
